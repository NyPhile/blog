...
return Class.create(/** @lends View.prototype */{
     ...
     * @param {Boolean} usePolyCollision Is use polygon collision, default value is false.
     */
    hitTestObject: function(object, usePolyCollision, returnXY){
        ...
        if(hit && returnXY){
            return {
                isHited : !!hit,
                isX: b1.x < b2.x + b2.width && b2.x < b1.x + b1.width,
                isY: b1.y < b2.y + b2.height && b2.y < b1.y + b1.height
            }
        }
        return !!hit;
    },
...
var Stage = Class.create(/** @lends Stage.prototype */{
    ...
    _onDOMEvent: function(e){
        ...
        if(isTouch){
            ...
            posObj = (touches && touches.length) ? touches[touches.length-1] :
                     (changedTouches && changedTouches.length) ? changedTouches[changedTouches.length-1] : null;
        }
